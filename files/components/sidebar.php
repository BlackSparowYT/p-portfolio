...
<div class="sidebar">
    <div class="sidebar-icons" id="SB-icons">
        ...
        <a href="orders.php"><img src="../files/icons/dash-orders.png"></a>
        <a href="reviews.php"><img src="../files/icons/dash-reviews.png"></a>
    ...
    <div class="sidebar-text" id="SB-text">
        ...
        <a href="orders.php"><h3>Jouw Orders</h3></a>
        <a href="reviews.php"><h3>Jouw Recensies</h3></a>
        <?php if ($_SESSION['admin'] == true) : ?>
            <hr>
